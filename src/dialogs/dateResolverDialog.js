...
class DateResolverDialog extends CancelAndHelpDialog {
    ...
    async initialStep(stepContext) {
        ...
        const promptMessageText = 'On what date would you like to workout ?';
        const promptMessage = MessageFactory.text(promptMessageText, promptMessageText, InputHints.ExpectingInput);

        const repromptMessageText = "I'm sorry, for best results, please enter your reservation date including the month, day and year.";
